...
class DisentangledShapesDataset(Dataset):
...
def load_shapes(root, val_split=0.8, shuffle=True, seed=42):
    # img_size = 64
    path = os.path.join(root, '3dshapes')
    dataset = DisentangledShapesDataset(path, transform=transforms.ToTensor())
